...
[1] = LAYOUT_preonic_grid(
    _______, _______, _______, _______, KC_DLR,  _______, _______, UK_LCBR, UK_RCBR, _______, _______, _______,
    _______, KC_PGUP, KC_UP,   KC_PGDN, KC_HOME, KC_END,  UK_BSLS, UK_LCBR, UK_RCBR, UK_LBRC, UK_RBRC, _______,
...
[3] = LAYOUT_preonic_grid(
    ...
    _______, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, _______, KC_PENT, KC_1,    KC_2,    KC_3,    _______, _______,
    _______, _______, _______, _______, _______, _______, _______, KC_0,    KC_NO,   UK_DOT,  _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
